...
<body style="display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; background-color: #FAF5EB;">
    ...
    <form action='../Controller/Navegacao.php' method="post" class="w3-container w3-card-4 w3-light-grey w3-text-orange w3-margin "style="width: 30%; background-color: #122833;">
        ...
        <div class="w3-row w3-section">
            <div class="w3-center">
                <button name="btnCadastrar" class="w3-button w3-block w3-margin w3-text-orange w3-cell w3-round-large"style="width: 90%; background-color: #122833;">Cadastrar</button>
            </div>
        </div>
    </form>
</body>
